...
public:
	...
	static	const bool	Is_Ruzgar_Ayakkabi(DWORD vnum)	{ return 72701 == vnum; }

	/// 발렌타인 사랑의 팬던트
	static	const bool	IsLovePendant(DWORD vnum)		{ return 71145 == vnum; }
	///acce
	static	const bool	IsAcce_Grade1(DWORD vnum)		{return 85001 == vnum || 85005 == vnum || 85010 == vnum || 85014 == vnum || 85021 == vnum; }
	static	const bool	IsAcce_Grade2(DWORD vnum)		{return 85002 == vnum || 85006 == vnum || 85011 == vnum || 85015 == vnum || 85022 == vnum; }
	static	const bool	IsAcce_Grade3(DWORD vnum)		{return 85003 == vnum || 85007 == vnum || 85012 == vnum || 85016 == vnum || 85023 == vnum; }
	static	const bool	IsAcce_Grade4(DWORD vnum)		{return 85004 == vnum || 85008 == vnum || 85013 == vnum || 85017 == vnum || 85024 == vnum; }	
};
