...
class CInputMain : public CInputProcessor
{
	...
	protected:
		...
		void		NewQuickslotAdd(LPCHARACTER ch, const char * data);
		void		NewQuickslotDelete(LPCHARACTER ch, const char * data);
		void		NewQuickslotSwap(LPCHARACTER ch, const char * data);
#endif
