...
CPacketInfoCG::CPacketInfoCG()
{
    ...
    Set(HEADER_CG_NEWQUICKSLOT_ADD, sizeof(TPacketCGNewQuickslotAdd), "NewQuickslotAdd", true);
    Set(HEADER_CG_NEWQUICKSLOT_DEL, sizeof(TPacketCGNewQuickslotDel), "NewQuickslotDel", true);
    Set(HEADER_CG_NEWQUICKSLOT_SWAP, sizeof(TPacketCGNewQuickslotSwap), "NewQuickslotSwap", true);
#endif
	...
	Set(HEADER_CG_UPGRADE_ITEMS_STORAGE_CHECKOUT, sizeof(TPacketCGUpgradeItemsStorageCheckout), "UpgradeItemsStorageCheckout", true);
	Set(HEADER_CG_UPGRADE_ITEMS_STORAGE_CHECKIN, sizeof(TPacketCGUpgradeItemsStorageCheckin), "UpgradeItemsStorageCheckin", true);
	Set(HEADER_CG_UPGRADE_ITEMS_STORAGE_ITEM_MOVE, sizeof(TPacketCGItemMove), "UpgradeItemsStorageItemMove", true);
#endif
