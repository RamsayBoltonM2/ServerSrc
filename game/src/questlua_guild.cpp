...
namespace quest
{
	...
	int guild_online(lua_State* L)
	{
		...
		if (pkGuild->GetMasterCharacter() != NULL)
		{
	...
	int guild_kac_kisi(lua_State* L)
	{
		...
		lua_pushnumber(L, g1->GetMemberCount());
